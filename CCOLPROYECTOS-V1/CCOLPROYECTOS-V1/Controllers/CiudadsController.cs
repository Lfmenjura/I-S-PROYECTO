...
namespace CCOLPROYECTOS_V1.Controllers
{
    public class CiudadsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,codigoCiudad,nombreCiudad,idDepartamento")] Ciudad ciudad)
        {
            ...
            ViewBag.idDepartamento = new SelectList(db.Departamento, "id", "nombreDepartamento", ciudad.idDepartamento);
            return View(ciudad);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,codigoCiudad,nombreCiudad,idDepartamento")] Ciudad ciudad)
        {
            if (ModelState.IsValid)
            {
